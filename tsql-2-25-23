...
/****** Object:  Database [trade]    Script Date: 2/25/2023 1:15:39 PM ******/
CREATE DATABASE [trade]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'trade', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\trade.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'trade_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\trade_log.ldf' , SIZE = 401408KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [trade]
GO
/****** Object:  Table [dbo].[Predictions]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  View [dbo].[vwAllPredictions]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AccountBalance]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AssetPairs]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Currencies]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Log]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OHLC]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ohlcloadstatus]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ResponseTime]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Ticker]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tickerloadstatus]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ACCOUNTBALANCE_DELETE_ALL]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ACCOUNTBALANCE_INSERT]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[GET_BAL_BTC]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_BAL_BTC]
AS

BEGIN
	SELECT top 1 [btc] FROM [trade].[dbo].[AccountBalance]
END
GO
/****** Object:  StoredProcedure [dbo].[GET_BAL_DASH]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_BAL_DASH]
AS

BEGIN
	SELECT top 1 dash FROM [trade].[dbo].[AccountBalance]
END
GO
/****** Object:  StoredProcedure [dbo].[GET_BAL_DGE]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_BAL_DGE]
AS

BEGIN
	SELECT top 1 dge FROM [trade].[dbo].[AccountBalance]
END
GO
/****** Object:  StoredProcedure [dbo].[GET_BAL_ETH]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_BAL_ETH]
AS

BEGIN
	SELECT top 1 eth FROM [trade].[dbo].[AccountBalance]
END
GO
/****** Object:  StoredProcedure [dbo].[GET_BAL_LTC]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_BAL_LTC]
AS

BEGIN
	SELECT top 1 LTC FROM [trade].[dbo].[AccountBalance]
END
GO
/****** Object:  StoredProcedure [dbo].[GET_BAL_REP]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_BAL_REP]
AS

BEGIN
	SELECT top 1 rep FROM [trade].[dbo].[AccountBalance]
END
GO
/****** Object:  StoredProcedure [dbo].[GET_BAL_XMR]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_BAL_XMR]
AS

BEGIN
	SELECT top 1 xmr FROM [trade].[dbo].[AccountBalance]
END
GO
/****** Object:  StoredProcedure [dbo].[GET_BAL_ZEC]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_BAL_ZEC]
AS

BEGIN
	SELECT top 1 zec FROM [trade].[dbo].[AccountBalance]
END
GO
/****** Object:  StoredProcedure [dbo].[GET_PRICE_BTC]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
CREATE PROCEDURE [dbo].[GET_PRICE_BTC]
AS

BEGIN
	SELECT top 1 ask FROM [trade].[dbo].[Ticker] where assetpair = 'XXBTZUSD'
 END
GO
/****** Object:  StoredProcedure [dbo].[GET_PRICE_DASH]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
CREATE PROCEDURE [dbo].[GET_PRICE_DASH]
AS

BEGIN
	SELECT top 1 ask FROM [trade].[dbo].[Ticker] where assetpair = 'DASHUSD'
 END
GO
/****** Object:  StoredProcedure [dbo].[GET_PRICE_DGE]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
CREATE PROCEDURE [dbo].[GET_PRICE_DGE]
AS

BEGIN
	SELECT top 1 ask FROM [trade].[dbo].[Ticker] where assetpair = 'XDGUSD'
 END
GO
/****** Object:  StoredProcedure [dbo].[GET_PRICE_ETH]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
CREATE PROCEDURE [dbo].[GET_PRICE_ETH]
AS

BEGIN
	SELECT top 1 ask FROM [trade].[dbo].[Ticker] where assetpair = 'XETHZUSD'
 END
GO
/****** Object:  StoredProcedure [dbo].[GET_PRICE_LTC]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
CREATE PROCEDURE [dbo].[GET_PRICE_LTC]
AS

BEGIN
	SELECT top 1 ask FROM [trade].[dbo].[Ticker] where assetpair = 'XLTCUSD'
 END
GO
/****** Object:  StoredProcedure [dbo].[GET_PRICE_REP]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
create PROCEDURE [dbo].[GET_PRICE_REP]
AS

BEGIN
	SELECT top 1 ask FROM [trade].[dbo].[Ticker] where assetpair = 'XREPZUSD'
 END
GO
/****** Object:  StoredProcedure [dbo].[GET_PRICE_XMR]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
CREATE PROCEDURE [dbo].[GET_PRICE_XMR]
AS

BEGIN
	SELECT top 1 ask FROM [trade].[dbo].[Ticker] where assetpair = 'XMRUSD'
 END
GO
/****** Object:  StoredProcedure [dbo].[GET_PRICE_ZEC]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
CREATE PROCEDURE [dbo].[GET_PRICE_ZEC]
AS

BEGIN
	SELECT top 1 ask FROM [trade].[dbo].[Ticker] where assetpair = 'XZECUSD'
 END
GO
/****** Object:  StoredProcedure [dbo].[Log_INSERT]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[OHLC_DELETE_ALL]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[OHLC_GET_STATUS]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[OHLC_INSERT]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[OHLC_SET_STATUS_LOADING]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[OHLC_SET_STATUS_READY]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[PREDICTIONS_DELETE_ALL]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Predictions_INSERT]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ResponseTime_INSERT]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TICKER_DELETE_ALL]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TICKER_GET_CurrentPrice]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TICKER_GET_STATUS]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TICKER_INSERT]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TICKER_SET_STATUS_LOADING]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[TICKER_SET_STATUS_READY]    Script Date: 2/25/2023 1:14:36 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
